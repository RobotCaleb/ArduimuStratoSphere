...
/* NOTE!  Hardware version - Can be used for v1 (daughterboards),
              v2 (flat) or new v3 (MPU6000)
              1 For V1
              2 for V2
              3 for V3  */
...
/* GPS        0 for GPS pins
              1 for programming pins */
#define GPS_CONNECTION 0

/* GPS Type Selection - Note Ublox or MediaTek is recommended.
              Support for NMEA is limited.
              1 - NMEA
              2 - EM406
              3 - Ublox
              4 - MediaTek  */
...
/* Enable Air Start uses Remove Before Fly flag
              ...
              0 if not using airstart/groundstart signaling
              1 if using airstart/groundstart signaling */
#define ENABLE_AIR_START 0
/* Pin number used for ground start signal
              (recommend 10 on v1 and 8 on v2 hardware) */
#define GROUNDSTART_PIN 8

/* Min Speed Filter for Yaw drift Correction
              >1 use as min speed filter for yaw drift cancellation (m/s),
              0 do not use speed filter  */
#define SPEEDFILT 2

/* For debugging propurses
              1 Will print Debug messages
              0 not */
#define PRINT_DEBUG 1

/* OUTPUTMODE 0 will print uncorrected data of the gyros (with drift)
              1 will print the corrected data
              2 will print accelerometer only data */
#define OUTPUTMODE 1

/* *** NOTE!  To use ArduIMU with ArduPilot you must select binary
              output messages (change to 1 here)
              1 Will print binary message and suppress ASCII messages (below)*/
#define PRINT_BINARY 0

/* *** NOTE!  Performance reporting is only supported for Ublox.
              Set to 0 for others
              1 Will include performance reports in the binary output ~ 1/2 min*/
#define PERFORMANCE_REPORTING 1

/* Support for optional magnetometer
              1 if you want to make yaw gyro
              drift corrections using the optional magnetometer */
...
/* Will print GPS data */
#define PRINT_GPS 1
/* Will print Magnetometer data */
#define PRINT_MAGNETOMETER USE_MAGNETOMETER && 1

/* Local magnetic declination (in degrees)
              I use this web : http://www.ngdc.noaa.gov/geomagmodels/Declination.jsp
              Corrects magnetic bearing to true north */
#define MAGNETIC_DECLINATION 4.4
...
/* Support for optional barometer (1 enabled, 0 dissabled)
              1 to get altitude using the optional absolute pressure sensor */
#define USE_BAROMETER 0
/* For binary messages: GPS or barometric altitude.
              0 to 100 = % of barometric.
